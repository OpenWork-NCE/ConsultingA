...
export function ContactCTA() {
  ...
  return (
    <section className="py-24 md:py-32 border-t border-[var(--color-border)]">
      <Container>
        <div className="relative overflow-hidden rounded-[12px] bg-midnight px-10 py-16 md:px-16 md:py-24 flex flex-col items-start">
          {/* Animated beams provide the cinematic atmosphere on the climax surface. */}
          <BackgroundBeams />
